...
import "./EIP712WithModifier.sol";
import "fhevm/lib/TFHE.sol";

contract sFHE is EIP712WithModifier {
    ...
    constructor() EIP712WithModifier("StreamableFHE", "1") {
    ...
    function createStream(
        ...
        // TFHE.optReq(TFHE.le(encryptedFlowrate * 10, balances[msg.sender]));
